...
greyRow.addEventListener('click', makeColorToggleMenuInvisible);
redRow.addEventListener('click', makeColorToggleMenuInvisible);
orangeRow.addEventListener('click', makeColorToggleMenuInvisible);
purpleRow.addEventListener('click', makeColorToggleMenuInvisible);
greenRow.addEventListener('click', makeColorToggleMenuInvisible);
...
// target element of which you want to show the color as a word on the background:
...
tekstGrey.classList.add('make-invisible');
tekstRed.classList.add('make-invisible');
tekstOrange.classList.add('make-invisible');
tekstPurple.classList.add('make-invisible');
tekstGreen.classList.add('make-invisible');

// after selecting a background color, also show this color on the html background as a word, e.g. "Green"
const changeTekstOnDocumentBackground = (targetElementToUpdate, tekstOnBackground) => {
    tekstGrey.classList.add('make-invisible');
    tekstRed.classList.add('make-invisible');
    tekstOrange.classList.add('make-invisible');
    tekstPurple.classList.add('make-invisible');
    tekstGreen.classList.add('make-invisible');
    targetElementToUpdate.classList.remove(tekstOnBackground);
}

greyRow.addEventListener('click', function () { changeTekstOnDocumentBackground(tekstGrey, 'make-invisible') });
redRow.addEventListener('click', function () { changeTekstOnDocumentBackground(tekstRed, 'make-invisible') });
orangeRow.addEventListener('click', function () { changeTekstOnDocumentBackground(tekstOrange, 'make-invisible') });
purpleRow.addEventListener('click', function () { changeTekstOnDocumentBackground(tekstPurple, 'make-invisible') });
greenRow.addEventListener('click', function () { changeTekstOnDocumentBackground(tekstGreen, 'make-invisible') });
